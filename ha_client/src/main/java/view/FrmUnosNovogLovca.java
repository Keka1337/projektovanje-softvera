 ...
 * @author Jelena
 */
public class FrmUnosNovogLovca extends javax.swing.JFrame {

    /**
     * Creates new form FrmUnosNovogLovca
     */
    public FrmUnosNovogLovca() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUnosNovogLovca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmUnosNovogLovca().setVisible(true);
            }
        });
    }
