 ...
 * @author Jelena
 */
public class FrmUnosNovogTermina extends javax.swing.JFrame {

    /**
     * Creates new form FrmUnosNovogTermina
     */
    public FrmUnosNovogTermina() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUnosNovogTermina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmUnosNovogTermina().setVisible(true);
            }
        });
    }
